    ...
    return (
        <div className="max-w-7xl mx-auto p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {orders.map((order) => (
                    <div key={order._id} className="bg-white shadow-lg rounded-lg p-6 space-y-4">
                        ...
                        <div className="text-sm text-gray-500 space-y-2">
                            <p><strong>Shipping to:</strong><br/> {order.address.name}</p>
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-sm text-gray-500"><b>Total: ₹ {order.totalAmount.netAmount}</b></p>
                        </div>
                        ...
                        <Button onClick={()=>router.push(`/orders/${order._id}`)}> Details</Button>
                        </div>
                    </div>
                ))}
            </div>
